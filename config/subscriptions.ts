...
export const SUBSCRIPTION_TIERS: ProductTier[] = [
  {
    name: "Starter",
    id: "tier-hobby",
    productId: "prod_1agVTO9qrczAMkdeV2tsmW", // $11 monthly subscription
    priceMonthly: "$11",
  ...
  },
  {
    name: "Business",
    id: "tier-pro",
    productId: "prod_1immgKStX3hkkipwJYUIZj", // $29 monthly subscription (测试产品)
    priceMonthly: "$29",
  ...
  },
  {
    name: "Enterprise",
    id: "tier-enterprise",
    productId: "prod_4mK657gfo7V7VKE04vEL6R", // $99 monthly subscription
    priceMonthly: "$99",
...
export const CREDITS_TIERS: ProductTier[] = [
  ...
  },
  {
    ...
    id: "tier-6-credits",
    productId: "prod_7ACQLqgSZpHTG0HZ8sFhKw", // $13 one-time purchase
    priceMonthly: "$13",
  ...
  },
  {
    ...
    id: "tier-9-credits",
    productId: "prod_5U92P7uTfJEIwDFqyFVj4p", // $29 one-time purchase
    priceMonthly: "$29",
